...
var SmpleGHPrj = angular.module('SmpleGHPrj');
SmpleGHPrj.service('Util', function($filter) {
...
SmpleGHPrj.service('BSServiceUtil', function(AlertService, ExportService, BSService, Cache) {
    ...
    this.queryResultWithCallback = function(dsName, keyName, wC, wCparams, oB, callback, limit, offset, isCount, isExport, selectClause) {
        ...
        _ser.query({
            ...
            if (result.status === "E") {
            		AlertService.showError( result.title , result.errorMsg);
            } else {
...
SmpleGHPrj.service('EmailService', function(AlertService, BSService) {
...
SmpleGHPrj.service('CommentService', function(AlertService, BSService) {
...
SmpleGHPrj.factory('ExportService', function($resource) {
...
SmpleGHPrj.factory('BSService', function($resource) {
...
SmpleGHPrj.service('AlertService', function(SweetAlert) {
...
SmpleGHPrj.service('AppService', function(AlertService, BSServiceUtil, AlertService, Cache) {
...
SmpleGHPrj.service('Cache', function() {
    var map;
